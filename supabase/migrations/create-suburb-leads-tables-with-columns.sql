-- ============================================================
-- Suburb Leads, No Agent - Tables with Actual Columns
-- Auto-generated from Excel file
-- ============================================================

-- Sheet1 tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent (
...
-- NSW tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_nsw (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
...
-- QLD tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_qld (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
...
-- WA tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_wa (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
...
-- VIC tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_vic (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
...
-- SA tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_sa (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
...
-- NT tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_nt (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
...
-- TAS tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_tas (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
...
-- ACT tab
CREATE TABLE IF NOT EXISTS suburb_leads_no_agent_act (
    id BIGSERIAL PRIMARY KEY,
    state TEXT,
    suburb TEXT,
    address TEXT,
